...
\label{rem:scope}
The logical structure of Theorem~\ref{thm:closure} is essentially: ``a Clifford algebra, homomorphically embedded in a larger algebra, lands as a Clifford subalgebra.''
...
(iii)~the injectivity guarantee from semisimplicity (Lemma~\ref{lem:semisimple}).
