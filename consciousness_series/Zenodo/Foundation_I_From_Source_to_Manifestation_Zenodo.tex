...
\item \(\{\mathcal E_t\}_{t\ge 0}\) is a strongly continuous semigroup
  of normal completely positive unital maps on \(\mathcal A_U\).
\end{enumerate}
\end{definition}
...
separating for \(\mathcal A_U\), together with a strongly continuous
semigroup of normal completely positive unital maps
\(\{\mathcal E_t\}_{t\ge 0}\) on \(\mathcal A_U\). This is the source
datum formalized in Section~\ref{sec:ledger}.
