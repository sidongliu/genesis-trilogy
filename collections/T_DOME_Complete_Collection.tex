...
yielding~\eqref{II-eq:anti_correlation}.
...
\end{itemize}
The numerical demonstration in Section~\ref{II-sec:numerical} provides preliminary evidence for this transition.
...
Theorem~\ref{II-thm:tradeoff} predicts that the mutual information between an agent's compressed representation and the full environmental state satisfies:
\begin{equation}
\frac{I_{\mathrm{discarded}}}{I_{\mathrm{pred}}} \gtrsim 1 - \frac{k^*}{D}
\label{II-eq:discard-scaling}
\end{equation}
...
Theorem~\ref{II-thm:delusion} predicts a critical timescale $t_{\mathrm{del}} = \Lambda^{-1} \ln(\pi / 4\theta_0)$ beyond which a fixed-frame agent's gradient updates become anti-correlated with the true optimum.
...
\item[\textup{(III)}] \textbf{Self-monitoring function.}
  ...
  Theorem~\ref{III-thm:loop_stability}.\par}
...
Zenodo (2026), DOI: 10.5281/zenodo.18367060.
...
Zenodo (2026), DOI: 10.5281/zenodo.18525876.
...
Zenodo (2026), DOI: 10.5281/zenodo.18525890.

\bibitem{Liu2026QRAIF_C}
S.~Liu,
\emph{The Realizability Bridge: Algebraic Closure in the
Q-RAIF Framework},
Zenodo (2026), DOI: 10.5281/zenodo.18528934.
