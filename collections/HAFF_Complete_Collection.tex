...
\begin{tabular}{ll}
Paper A & DOI: 10.5281/zenodo.18361707 \\
Paper B & DOI: 10.5281/zenodo.18367061 \\
Essay C & DOI: 10.5281/zenodo.18374806 \\
Paper D & DOI: 10.5281/zenodo.18388882 \\
Paper E & DOI: 10.5281/zenodo.18400066 \\
Paper F & DOI: 10.5281/zenodo.18400426 \\
Paper G & DOI: 10.5281/zenodo.18402908 \\
Postscript & DOI: 10.5281/zenodo.18407368 \\
\end{tabular}
\\[3em]
...
This terminology, borrowed from YogÄcÄra philosophy (referring to the ``storehouse consciousness''), is used here strictly in a technical sense.
...
By the refinement relation (Definition~\ref{def:A-refine}), no unitary can relate them unless $\mathbf{c}_1 \succeq \mathbf{c}_2$ or vice versa.
\end{proof}
...
Yog\=ac\=ara (``Yoga practice'') is a Mah\=ay\=ana Buddhist philosophical school emphasizing the role of consciousness (\emph{vija±\=ana}) in constituting experienced reality. Central to Yog\=ac\=ara is the concept of \textbf{\=alaya-vija±\=ana} (Skt. à¤†à¤²à¤¯à¤µà¤¿à¤œà¥à¤žà¤¾à¤¨, ``storehouse consciousness''), a foundational stratum of mind that stores karmic seeds (\emph{b\={\i}ja}) conditioning future experience \cite{Asanga_Mahayana,Vasubandhu_Trimsika}.
...
The M\=adhyamaka (``Middle Way'') tradition, founded by N\=ag\=arjuna (c.\ 2nd century CE), articulates \textbf{Å›Å«nyat\=a} (Skt. à¤¶à¥‚à¤¨à¥à¤¯à¤¤à¤¾, ``emptiness'') as the absence of \textbf{svabh\=ava} (Skt. à¤¸à¥à¤µà¤­à¤¾à¤µ, ``intrinsic nature'' or ``own-being'') \cite{Nagarjuna_MMK_Garfield1995}. 

This concept bears structural resemblance to the notion of ``emptiness'' developed in Part III (Â§\ref{sec:C-III.3}), where it denoted absence of intrinsic being without entailing non-existence. We emphasize that this parallel concerns the \emph{structural form} of the claim''”denial of substance while affirming functional reality''”not historical influence or causal connection \cite{Garfield2002,Siderits2007}.
...
A structural reading: entities lacking intrinsic being (empty) can nonetheless participate in stable relational networks (dependent arising). This maps onto the framework developed in Â§\ref{sec:C-III.4}: subsystems are empty (coarse-graining-dependent, lacking intrinsic factorization) yet existent (exhibiting objective entanglement structure).

\paragraph{Recursive emptiness and second-order structure.}
A subtle question arises: in M\=adhyamaka, emptiness applies universally, including to emptiness itself''”``emptiness is empty'' (\emph{Å›Å«nyat\=a-Å›Å«nyat\=a}). Does HAFF's relational existence admit similar recursive application?
...
M\=adhyamaka Å›Å«nyat\=a is deployed soteriologically''”to undermine attachment to fixed views and facilitate liberation. HAFF's ``emptiness'' is a technical descriptor of relational structure, with no soteriological function. The similarity is formal, not practical or existential.
...
This is consonant with the account of memory developed in Â§\ref{sec:C-I.5}: causal traces are not storage of intrinsic properties but maintenance of relational structure across time.
...
Having noted possible parallels, we now emphasize substantive divergences''”areas where Buddhist frameworks and HAFF diverge structurally, methodologically, or conceptually. This section is weighted equally to Â§\ref{sec:C-IV.2}--\ref{sec:C-IV.4} to prevent over-interpreting formal similarities.
...
We conclude Part IV by reaffirming interpretive humility. The parallels identified''”between accessible algebras and \=alaya-vija±\=ana, between emptiness and Å›Å«nyat\=a, between constraint propagation and karma''”are \emph{suggestive but inconclusive}.
...
Can the conjecture stated in Section~\ref{sec:D-technical} be formalized with sufficient precision to permit mathematical investigation? What would constitute a proof''”or disproof''”of the claim that gravitational phenomena are coarse-graining effects?
...
Asaá¹…ga, \emph{MahÄyÄnasaá¹ƒgraha (Summary of the Great Vehicle)}, trans.\ Ã‰. Lamotte, Peeters (1973).
...
D. Lusthaus, \emph{Buddhist Phenomenology: A Philosophical Investigation of YogÄcÄra Buddhism and the Ch'eng Wei-shih lun}, Routledge (2002).
...
NÄgÄrjuna, \emph{The Fundamental Wisdom of the Middle Way: NÄgÄrjuna's MÅ«lamadhyamakakÄrikÄ}, trans.\ J. L. Garfield, Oxford University Press (1995).
...
\bibitem{SuttaNipata}
\emph{Sutta NipÄta}, in \emph{The Group of Discourses (Sutta NipÄta)}, trans.\ K. R. Norman, Pali Text Society (2001).
...
Vasubandhu, \emph{Triá¹ƒÅ›ikÄ-vijÃ±aptimÄtratÄ (Thirty Verses on Consciousness Only)}, trans.\ S. Anacker, in \emph{Seven Works of Vasubandhu}, Motilal Banarsidass (1984).
...
\bibitem{Waldron2003}
W. S. Waldron, \emph{The Buddhist Unconscious: The Ä€laya-vijÃ±Äna in the Context of Indian Buddhist Thought}, Routledge (2003).
